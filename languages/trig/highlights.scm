; TriG Syntax Highlighting for Zed
; TriG extends Turtle, so we inherit the same highlighting

; Inherits from Turtle grammar
...
; Punctuation - Brackets (TriG adds graph blocks with {})
[
  "("
  ")"
  "["
